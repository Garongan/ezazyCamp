        ...
        <View style={{ flex: 1 }}>
            ...
            >
                <View style={{ flex: 1, justifyContent: "flex-end", paddingBottom: 50 }}>
                    ...
                    <Text style={[typography.body, { color: theme.colors.text, paddingVertical: 10 }]}>
                    ...
                    >
                        <Text style={[typography.body, { color: theme.colors.primary}]}>
                            Daftar Sekarang
                        </Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                    ...
                    >
                        <Text style={[typography.body, { color: theme.colors.primary }]}>Sudah Punya Akun? Masuk</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
